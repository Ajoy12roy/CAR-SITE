...
const CarCards = ({ car, onClick }) => {

const currency = import.meta.env.VITE_CURRENCY 

  return (
    <div onClick={onClick} className='md:w-80 md:h-auto  group rounded-xl overflow-hidden shadow-lg
    hover:translate-y-1 transition-all cursor-pointer duration-500'>

    <div className=' relative w-80 h-48 md:h-48 overflow-hidden'>
